...
COPY . /root/acmeair-customerservice-springboot
...
WORKDIR /root/acmeair-customerservice-springboot
RUN mvn clean package

EXPOSE 80
CMD ["java", "-jar", "/root/acmeair-customerservice-springboot/target/acmeair-customerservice-springboot-2.1.1-SNAPSHOT.jar", "--LICENSE=accept"]
